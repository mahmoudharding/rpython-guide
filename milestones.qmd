...
| `[M]` | 5.0 | 5.0 | Several requirements are unmet or unclear. Significant revision is required before the dataset can be approved. **Dataset not yet approved.** |
| `[MJ]` | 7.0 | 3.0 | Multiple major requirements are unmet, or the dataset has fundamental problems that make it unsuitable without substantial revision or replacement. **Dataset not yet approved.** |
| `[S]` | 8.0 | 2.0 | Most requirements are unmet or violated. The dataset is not viable in its current form and should be replaced. **Dataset not yet approved.** |
...
| `[M]` | 5.0 | 5.0 | Several required elements are missing, incomplete, or unclear. Significant revision is required. |
| `[MJ]` | 7.0 | 3.0 | Multiple major required elements are missing or insufficiently documented. The datasheet does not adequately describe the dataset and requires substantial revision. |
| `[S]` | 8.0 | 2.0 | Most required elements are missing or unclear. The datasheet does not meaningfully document the dataset. |
...
| Severity Tag | Points Deducted | Points Earned | Explanation |
|--------------|----------------:|--------------:|-------------|
| `[C]` | 0.0 | 3.0 | The research question fully meets the stated requirements. It is clear, specific, investigable, involves two or more variables, avoids causal language, and includes a meaningful justification. |
| `[e]` | 0.1875 | 2.8125 | The research question meets the stated requirements, with only minor issues related to wording, specificity, variable identification, or justification. |
| `[m]` | 0.375 | 2.625 | The research question is generally appropriate, but one aspect could be improved (e.g., clarity, specificity, variable identification, or justification). |
| `[M]` | 0.75 | 2.25 | A key element of the research question is missing or substantially weak, requiring significant revision. |
| `[MJ]` | 1.5 | 1.5 | Multiple required elements are missing or substantially weak, requiring major revision before the question can support a meaningful investigation. |
| `[S]` | 2.25 | 0.75 | The research question does not meet most of the stated requirements and is not suitable for a meaningful data investigation without substantial revision. |
| `[X]` | 3.0 | 0.0 | Missing or required work is not present. |
: {tbl-colwidths="[15,15,15,55]"}
:::
...
| Severity Tag | Points Deducted | Points Earned | Explanation |
|--------------|-----------------|---------------|-------------|
| `[C]` | 0.0 | 2.0 | The response correctly addresses the question and meets all requirements. |
...
| `[M]` | 0.5 | 1.5 | A key element is missing or incorrect. |
| `[MJ]` | 1.0 | 1.0 | The main idea or a required element is missing or incorrect. |
| `[S]` | 1.5 | 0.5 | An attempt was made, but most elements are missing or incorrect. |
| `[X]` | 2.0 | 0.0 | Missing or required work is not present. |
: {tbl-colwidths="[15,15,15,55]"}
:::
