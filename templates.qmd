...
::: {.callout-note}
A copy of this template can be found [here](https://docs.google.com/document/d/1Az9RWUKFe68S-jbBoNqpfjAKR_EuacyUT3PnAFMc6sI/edit?tab=t.0){target="_blank"}. Create your own copy and complete it before submitting.
:::
...
::: {.callout-note}
A copy of this template can be found [here](https://docs.google.com/document/d/1-R2ZNy_uzcWJyzzptzo_EefJbUd91Cr3PECABm1RNVc/edit?tab=t.0){target="_blank"}. Create your own copy and complete it before submitting.
:::
...
::: {.callout-note}
A copy of this template can be found [here](https://docs.google.com/document/d/1_XkRnikE2ncdhj0SwDs9jkEfPop4HEbkByOTX_UVeYY/edit?tab=t.0){target="_blank"}. Create your own copy and complete it before submitting.
:::
...
> **Avoid:** *What is the average salary?* <br> **Use:** *What is the relationship between years of experience and salary?*
...
> **Avoid:** *Is there a connection between studying and grades?* <br> **Use:** *How does the number of hours studied relate to final exam scores among high school students?*  
...
> **Avoid:** *Does income affect education level?* <br> **Use:** *What is the relationship between income and education level?*
...
> **Good:** *What is the relationship between physical activity and heart rate?* <br> **Better:** *What is the relation
...
- Removing the placeholder text from the **Planned Analysis ** and  **Visualization ** sections.
- Adding code that implements the analyses described in your analysis plan.
- Adding code to create the visualizations identified in your analysis plan.
- Writing commentary to each  **Interpretation of Findings** section that interprets and communicates the findings from your analysis output and visualizations.
- Completing the  **Summary ** section.
- Completing the  **Course Reflection ** section.